...
DATAFILES = ['data\dataset\labelled_dataset_2.csv', 'data\dataset\labelled_dataset_3.csv']
...
def svm_cross_val(features, labels):
    ...
    for c in c_weights:
        ...
        model = OneVsRestClassifier(LinearSVC(penalty='l2', dual=True, C=c, max_iter=3000))
        model.fit(x_train, y_train)
